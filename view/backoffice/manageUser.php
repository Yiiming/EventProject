...
<body>
	...
	<div id="tabs">
		<ul class="nav nav-tabs">
			<li class="inscriptionTabs active" name="state1" value="1"><a href="manageUser.php">Inscription en attente</a></li>
			<li class="inscriptionTabs" name="state2" value="2"><a href="refusedUser.php">Inscription refusée</a></li>
			<li class="inscriptionTabs" name="state3" value="3"><a href="acceptedUser.php">Inscription validée</a></li>
		</ul>
		<?php 
			$etat = 1;
